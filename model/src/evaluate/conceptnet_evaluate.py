...
class ConceptNetGenerationEvaluator(base_evaluate.Evaluator):
    def __init__(self, opt, model, model_knowledge, data_loader, track = False):
    ...
    def batch(self, opt, nums_k, nums_s, average_loss_k, average_loss_s, batch_variables, eval_mode):
    ...
    def print_result(self, split, epoch_losses_k, epoch_losses_s):
        print("{} Loss: \t {}".format(
